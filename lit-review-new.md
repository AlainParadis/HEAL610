...
WIL activities support students in building a professional network {% cite usher_why_2020 %}
Employers play a crucial role in WIL initiatives, benefiting from several advantages. WIL serves as a pipeline for recruiting skilled graduates who are familiar with industry practices and expectations. Employers report reduced recruitment costs and risks when hiring graduates who have participated in WIL. Students bring fresh perspectives, innovative ideas and cutting-edge knowledge to the workplace, contributing to organizational growth and problem-solving {% cite mcrae_work-integrated_2018 %}. Collaborating with educational institutions fosters long-term relationships that support workforce development {% cite chatoor_working_2023 stirling_practical_2024 %}.

{% cite lester_work-integrated_2016 usher_why_2020 sattler_work-integrated_2011 sattler_work-integrated_2012 %}

{% cite freudenberg_its_2008 %} addresses employment readiness.  
Graduate skills demanded by employers include being confident communicators, team players, critical thinkers, problem solvers and having initiative (Harvey, Moon and Geall, 1997)

-   Faculty currency and network building

-   Addresses institutional goals

Almost half of Ontario’s higher education learners participate in some form of WIL to be better prepared for the workplace {% cite stirling_practical_2024 %}. Research shows that participants in WIL experience superior labour market outcomes, including a higher likelihood of employment and significantly higher incomes {% cite wyonch_class_2023 %}. Usher {% cite usher_why_2020 %} claims that WIL is a useful talent scouting opportunity for employers, forging new connections with up-and-coming graduates.
...
Collaborative leadership serves as the foundation for driving this change initiative. The approach involves forming a guiding coalition consisting of faculty members, students, industry partners, and college administrators. This coalition is composed of individuals with enough authority and influence to lead the change process. They will spur stakeholders to work together, to implement needed strategies, and to oversee them during implementation {% cite kotter_leading_2007 bryson_strategic_2018 %}.

<!-- DELETE? [Jones and Harvey](./bibliography/jones_distributed_2017.html) {% cite jones_distributed_2017 %} identify an environment of trust, a culture of respect and the acknowledgement of the need for collaborative leadership as necessary for the change process to succeed. -->

{% cite ansell_collaborative_2008 %}: Collaborative Governance in Theory and Practice  
{% cite henderson_strengthening_2017 %}
...
-   [Rousseau & ten Have](./bibliography/rousseau_evidence-based_2022.html)
...
### What Happens when Coalitions Fail?
...
A collaborative approach is useful, where stakeholders share a language, mutual understanding and trust to achieve learning outcomes {% cite henderson_strengthening_2017 lauer_change_2021 %}.
