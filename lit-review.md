...
The college does face the challenge of placing fairly large student cohorts with a finite number of employers in the region. The program is reliant on a limited number of employers that are prepared to host students {% cite fleming_successful_2018 %}. The administrative burden can also be a heavy one for the program and for the department.
