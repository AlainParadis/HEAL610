# -*- encoding: utf-8 -*-
# stub: jekyll-csv 0.1.1 ruby lib

Gem::Specification.new do |s|
  s.name = "jekyll-csv".freeze
  ...
  s.homepage = "https://github.com/theyworkforyou/jekyll-csv".freeze
  s.licenses = ["MIT".freeze]
  s.rubygems_version = "2.5.1".freeze
  s.summary = "Load CSVs into Jekyll Collections".freeze
