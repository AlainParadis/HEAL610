# -*- encoding: utf-8 -*-
# stub: github-pages 227 ruby lib

Gem::Specification.new do |s|
  s.name = "github-pages".freeze
  s.version = "227".freeze
  ...
  s.add_runtime_dependency(%q<jekyll>.freeze, ["= 3.9.2".freeze])
  s.add_runtime_dependency(%q<jekyll-sass-converter>.freeze, ["= 1.5.2".freeze])
  s.add_runtime_dependency(%q<kramdown>.freeze, ["= 2.3.2".freeze])
  s.add_runtime_dependency(%q<kramdown-parser-gfm>.freeze, ["= 1.1.0".freeze])
  s.add_runtime_dependency(%q<jekyll-commonmark-ghpages>.freeze, ["= 0.2.0".freeze])
  s.add_runtime_dependency(%q<liquid>.freeze, ["= 4.0.3".freeze])
  s.add_runtime_dependency(%q<rouge>.freeze, ["= 3.26.0".freeze])
  s.add_runtime_dependency(%q<github-pages-health-check>.freeze, ["= 1.17.9".freeze])
  ...
  s.add_runtime_dependency(%q<jekyll-feed>.freeze, ["= 0.15.1".freeze])
  s.add_runtime_dependency(%q<jekyll-gist>.freeze, ["= 1.5.0".freeze])
  s.add_runtime_dependency(%q<jekyll-paginate>.freeze, ["= 1.1.0".freeze])
  s.add_runtime_dependency(%q<jekyll-coffeescript>.freeze, ["= 1.1.1".freeze])
  s.add_runtime_dependency(%q<jekyll-seo-tag>.freeze, ["= 2.8.0".freeze])
  s.add_runtime_dependency(%q<jekyll-github-metadata>.freeze, ["= 2.13.0".freeze])
  s.add_runtime_dependency(%q<jekyll-avatar>.freeze, ["= 0.7.0".freeze])
  ...
  s.add_runtime_dependency(%q<jemoji>.freeze, ["= 0.12.0".freeze])
  ...
  s.add_runtime_dependency(%q<jekyll-default-layout>.freeze, ["= 0.1.4".freeze])
  ...
  s.add_development_dependency(%q<rubocop-github>.freeze, ["= 0.16.0".freeze])
end
